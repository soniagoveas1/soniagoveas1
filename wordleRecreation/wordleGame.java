...
public class wordleGame{
	...
	//will continue to run until any of the conditions within the loop becomes false
		while(true){
			...
			if(guess.contains(" ")){
				System.err.println("You must enter a word!");
				continue;
			}
			...
			if(guess.length() != 5){
				...
				System.err.println("ERROR! Your guess must be five letters long!");
			}			
...
//ends the game if the guesses used is greater than 6			
			if(guessNum == 6){
				System.out.println("Sorry! Better luck next time! The word was " + word);
				break;
			}
